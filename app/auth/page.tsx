...
export default function AuthPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0F172A', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      ...
      <div style={{ background: '#131C2E', borderRadius: 16, padding: '36px 32px', width: '100%', maxWidth: 420, boxShadow: '0 2px 16px rgba(0,0,0,0.07)' }}>

        {mode === 'forgot' ? (
          <>
            <button onClick={() => { setMode('signin'); setError(''); setSuccess('') }} style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#888780', display: 'flex', alignItems: 'center', gap: 6, fontSize: 13, marginBottom: 20, padding: 0, fontFamily: 'inherit' }}>
          ...
          <>
            ...
            <button onClick={handleGoogle} style={{ width: '100%', padding: 11, border: '1px solid #BFDBFE', borderRadius: 8, background: '#131C2E', cursor: 'pointer', fontSize: 14, fontWeight: 500, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, marginBottom: 20, fontFamily: 'inherit' }}>
